...
Языки функционального программирования можно использовать для удобной обработки исключений. Мы решим эту задачу на F# и C#, чтобы показать,
насколько функциональное проще.
...
Теперь, логгируя исключение, мы должны записать всю цепочку целиком, и это поможет нам отлаживать приложение.
